...
const [productTypes, setProductTypes] = useState([]);
  ...
  useEffect(() => {
    fetchData("/api/v1/productcategories", setProductCategories);
    fetchData("/api/v1/producttype", setProductTypes);
    fetchData("/api/v1/locations", setLocations);
    fetchData("/api/v1/products", setProducts);
    fetchData("/api/v1/purchase_types", setPurchaseTypes);
    fetchData("/api/v1/vendors", setVendors);
    fetchData(`/api/v1/asset/${params.id}`, setAssetData);
  }, [params.id]);
