...
const Dashboard = ({ sidebarOpen }) => {
  ...
  useEffect(() => {
    fetchData("/api/v1/total_vendors", setTotalVendors);
    fetchData("/api/v1/total_employees", setTotalEmployee);
    fetchData("/api/v1/total_assets", setTotalAsset);
    fetchData("/api/v1/totalcost_assets",setTotalCostAsset);
  }, []);
